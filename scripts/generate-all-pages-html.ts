...
const routes: PrerenderRoute[] = [
  ...
  { path: 'locations/west-columbia', title: 'Mobile Car Detailing West Columbia SC | From $125 | 5.0★ Rated', description: 'Mobile car detailing in West Columbia SC — exterior from $125, interior from $200, full detail $225. We come to you. 5.0★ rated, same-day available. Call (803) 667-8731.' },
  ...
  { path: 'pricing', title: 'Car Detailing Prices Columbia SC | From $125 | We Come to You', description: 'How much does car detailing cost? Columbia & Lexington SC: exterior from $125, interior from $200, full detail $225, factory reset $375. Mobile — we come to you. 5.0★ rated. (803) 667-8731.' },
