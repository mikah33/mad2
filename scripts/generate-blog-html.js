...
// Import blog data
const { blogPosts, getBlogPostBySlug } = require('../src/data/blog.ts');
const { generateCompleteBlogPostSchema } = require('../src/components/seo/BlogSchemas.tsx');
...
blogPosts.forEach((post) => {
  ...
  console.log(`✅ Generated: /blog/${post.slug}/index.html (${schemas.length} schemas)`);
});
