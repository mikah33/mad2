  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#023E8A]">
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-[#FFD700] p-3 md:hidden z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.3)]">
          <a
            href="tel:+18036678731"
            onClick={() => gtag_report_conversion()}
            className="flex items-center justify-center gap-2 w-full text-[#023E8A] font-bold text-lg"
          >
