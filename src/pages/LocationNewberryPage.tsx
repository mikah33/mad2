...
export const LocationNewberryPage = () => {
  ...
  // Newberry-specific FAQs
  const locationFAQs = [
    {
      question: 'Do you provide mobile auto detailing in Newberry SC?',
      answer: 'Yes! We provide comprehensive mobile auto detailing service throughout Newberry SC and surrounding rural areas. We come directly to your country property, farm, or business with all professional equipment.'
    },
    {
      question: 'What areas around Newberry SC do you serve?',
      answer: 'We serve all of Newberry including Downtown Newberry, Newberry College area, rural properties, farm areas, and all locations within 25 miles of Newberry. Perfect for agricultural vehicle and classic car care.'
    },
    {
      question: 'How much does car detailing cost in Newberry SC?',
      answer: 'Our car detailing prices in Newberry SC start at $375 for our Level 2 Full Reset, with our $225 Level 1 Maintenance Detail available anytime you rebook the same vehicle by day 90, with service by day 97. We offer special rates for farm vehicles, work trucks, and rural property service.'
    },
    {
      question: 'Do you detail farm vehicles and work trucks in Newberry?',
      answer: 'Absolutely! We specialize in farm vehicle cleaning, work truck detailing, agricultural equipment cleaning, and commercial fleet service in the Newberry area. Our mobile service is perfect for rural properties.'
    },
    {
      question: 'What makes your Newberry auto detailing service special?',
      answer: 'We understand the unique needs of rural Newberry properties and agricultural work. Our mobile service includes specialized care for farm equipment, work vehicles, and country property needs with reliable rural service.'
    }
  ];
  ...
  const localBusinessSchema = generateLocalBusinessSchema({
    name: "Mikah's Auto Detailing - Newberry SC",
    description: 'Professional mobile car detailing in Newberry SC. Rural property service, farm vehicle detailing, work truck care. 5.0★ rated serving Newberry County area.',
    phone: '(803) 667-8731',
  ...
  const locationData = getLocationData('newberry-sc');

  return (
    <>
      <SEOHead
        title="Mobile Detailing Newberry SC | Rural Auto Detailing & Farm Vehicle Care"
        description="Best mobile detailing Newberry SC. Professional auto detailing & farm vehicle care for rural properties. Full details from $375. 5.0★ 31 reviews. Serving Newberry County. Free quotes!"
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <Breadcrumbs
            items={[
              ...
              { label: 'Newberry SC', path: '/locations/newberry-sc' }
            ]}
          />
        </div>
      </div>
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="relative text-white min-h-screen w-full overflow-hidden flex items-center">
          ...
          <div className="container mx-auto px-4 text-center max-w-7xl relative z-10 pt-24 pb-12">
            <div className="flex items-center justify-center gap-2 text-primary-300 mb-6">
              ...
              <span className="text-sm md:text-base font-semibold">Mobile Detailing Newberry, SC</span>
            </div>

            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 leading-tight">
              Professional Auto Detailing
              <br />
              <span className="text-primary-300">Newberry, SC</span>
            </h1>
            ...
            <p className="text-lg sm:text-xl md:text-2xl font-semibold mb-6 md:mb-8 text-primary-300">
              ✨ Newberry County's Rural Specialist
            </p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
              Auto Detailing Services & Prices - Newberry SC
            </h2>
            <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
              Professional car detailing at your Newberry rural property or farm location. All prices include mobile service.
            </p>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
              Newberry SC Areas We Serve
            </h2>
            <p className="text-center text-gray-600 mb-12">
              Professional mobile detailing service throughout Newberry and surrounding rural communities
            </p>

            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
              {['Downtown Newberry', 'Newberry College Area', 'Rural Properties', 'Farm Areas',
                'Highway 26 Corridor', 'Newberry County', 'Agricultural Areas', 'Country Estates',
                'Business District', 'Rural Residential', 'Farm Equipment Areas', 'Work Sites'].map((area, i) => (
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            <InternalLinkingMatrix
              currentLocation="Newberry SC"
              currentSlug="newberry-sc"
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
              Mobile Detailing Newberry SC - Frequently Asked
            </h2>
        ...
        <section className="py-16 bg-gradient-to-br from-primary-700 to-primary-900 text-white">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <p className="text-primary-200 mt-6">
              Serving Newberry, Downtown, College Area, Rural Properties & all surrounding farm communities
            </p>
          </div>
        </section>
      </div>
...
export default LocationNewberryPage;