...
export const LocationIrmoPage = () => {
  ...
  const locationFAQs = [
    ...
    },
    {
      ...
      answer: "Mikah's Auto Detailing is the top-rated mobile detailing service in Irmo SC with a 5.0-star rating from 31 Google reviews. We're IDA certified, fully insured, and bring professional equipment directly to your location anywhere in Irmo, Harbison, or Chapin."
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes! We have 31 verified Google reviews with a perfect 5.0-star rating. Customers praise our professional mobile service, attention to detail, and convenient at-home detailing. Search "Mikah\'s Auto Detailing Irmo SC" on Google to read our reviews.'
    }
  ];
  ...
  const localBusinessSchema = generateLocalBusinessSchema(
    {
      ...
      description: 'Professional mobile car detailing in Irmo SC. Interior detailing, exterior detailing, ceramic coating, paint correction. 5.0★ rated with 31 reviews.',
      phone: '(803) 667-8731',
        ...
        <div className="relative text-white min-h-screen w-full overflow-hidden flex items-center">
          ...
          <div className="container mx-auto px-4 text-center max-w-7xl relative z-10 pt-24 pb-12">
            ...
            <p className="text-base sm:text-lg md:text-xl mb-6 md:mb-8 max-w-3xl mx-auto text-gray-100 px-4">
              ...
              detailing, paint correction. 5.0★ rated with 31 reviews. We come to you!
            </p>
        ...
        <section className="py-16 bg-gradient-to-br from-primary-700 to-primary-900 text-white">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <p className="text-xl text-primary-100 mb-8">
              Best mobile car detailing in Irmo SC. 5.0★ rating from 31 reviews. We come to you!
            </p>
