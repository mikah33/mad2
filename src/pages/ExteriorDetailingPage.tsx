            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="bg-blue-500 text-white rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 font-bold">6</div>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="bg-blue-500 text-white rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 font-bold">7</div>
                    <div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 max-w-7xl">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <img src="/exterior4.jpg" alt="Detailed car exterior" className="rounded-lg shadow-lg" />
              <img src="/exterior5.jpg" alt="Professional paint protection" className="rounded-lg shadow-lg" />
              <img src="/exterior6.jpg" alt="Car detailing results" className="rounded-lg shadow-lg" />
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-7xl">
            ...
            <div className="grid md:grid-cols-4 gap-4 max-w-4xl mx-auto text-center">
              <div className="bg-blue-50 p-4 rounded-lg">Columbia SC</div>
              <div className="bg-blue-50 p-4 rounded-lg">Lexington SC</div>
              <div className="bg-blue-50 p-4 rounded-lg">West Columbia SC</div>
              <div className="bg-blue-50 p-4 rounded-lg">Irmo SC</div>
              <div className="bg-blue-50 p-4 rounded-lg">Cayce SC</div>
              <div className="bg-blue-50 p-4 rounded-lg">Forest Acres SC</div>
              <div className="bg-blue-50 p-4 rounded-lg">Blythewood SC</div>
              <div className="bg-blue-50 p-4 rounded-lg">Lake Murray Area</div>
            </div>
          </div>
        </section>
